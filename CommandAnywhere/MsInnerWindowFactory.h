...
public:
    ...
    static MicrosoftInnerWindow* CreateLayerWindow2(HINSTANCE hInstance, const std::wstring& className, const MsWindowEventHandler& eventHandler) {
        return new MicrosoftInnerWindow(
